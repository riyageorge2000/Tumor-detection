...
image_dir='DL-ALGORITHMS/CNN/tumor_detection/tumordata'
...
make_prediction('DL-ALGORITHMS/CNN/tumor_detection/tumordata/yes/y6.jpg',model)
print("--------------------------------------\n")
make_prediction('DL-ALGORITHMS/CNN/tumor_detection/tumordata/no/no1.jpg',model)
print("--------------------------------------\n")
